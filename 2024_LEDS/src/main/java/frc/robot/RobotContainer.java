...
public class RobotContainer {
  ...
  private final LED_Subsystem LedSubsystem;
  ...
  public RobotContainer() {
    ...
    LedSubsystem = new LED_Subsystem();

    Operator = new XboxController(XBOX_PORT);
  ...
  private void configureBindings() {
    ...
    xButton.whileTrue(LedSubsystem.LED_GREEN_Command());
    aButton.whileTrue(LedSubsystem.LED_RED_Command());
